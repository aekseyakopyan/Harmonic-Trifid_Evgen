...
class GwenSupervisor:
    ...
    async def _ai_check(self, text: str) -> Dict:
        ...
        system_prompt = (
            ...
            "Ксения — менеджер-бот, ведёт холодные продажи через Telegram. "
...
- Ты готова обсуждать технические доработки. Если Ксения просит что-то внедрить, анализируй: "Мы можем это сделать, но потребуются правки в [модуль]".
