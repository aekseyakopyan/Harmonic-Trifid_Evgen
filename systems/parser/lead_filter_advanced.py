...
DIRECTION_KEYWORDS = {
    ...
    "контекстная реклама": [
        ...
        "баннерная реклама", "мастер кампаний",
        # Действия
        ...
        "конверсия из директ", "performance маркетинг",
        # Таргет (только ВК и Одноклассники — наша специализация)
        "таргет вк", "реклама вк", "vk реклама", "vk ads",
        "таргет одноклассники", "mytarget", "ok реклама",
        "таргетолог вк", "реклама вконтакте",
    ],
    "авито": [
        # Основное
    ...
    "разработка сайтов": [
        ...
        # Технологии
        "верстка", "веб разработка", "frontend", "backend", "fullstack",
    ...
    "маркетинг": [
        ...
        "roistat", "calltracking", "utm метки",
        # Email / CRM
